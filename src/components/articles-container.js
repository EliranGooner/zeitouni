...
const ArticlesContainer = (props) => {
  ...
  return <div dir="rtl">
    <Grid container className={styles.container} spacing={4} >
      <Grid item className={styles.item} xs={12} lg={3} md={6}>
      ...
      <Grid item className={styles.item} xs={12} lg={3} md={6}>
      <ArticleCard header='גבעת שמואל: 2,000 דירות על קרקע פרטית' preview='שכונת המגורים החדשה בגבעת שמואל, שתכלול כ-2,000 דירות, נכנסת לשלבי ביצוע שיווק. הוועדה המקומית לתכנון ולבנייה בעיר אישרה באחרונה תוספת בנייה בשיעור של 14% להיקף המגורים בשכונה' src='MSN ב- 1/11/2016' path='/' idx={6} />
      </Grid>
      <Grid item className={styles.item} xs={12} lg={3} md={6}>
      ...
      <Grid item className={styles.item} xs={12} lg={3} md={6}>
      <ArticleCard header='"מחפשי דירות - על "קבוצת רוכשים" שמעתם?"' preview='עליית מחירי הדירות מייצרת אינסוף המצאות ותרגילים ישראלים שנועדו להשיג הנחות לרוכשים • בענף הנדל"ן קמה תופעה חדשה – קבוצת רוכשים • מה זה אומר?' src='חדשות ערוץ 10, המהדורה המרכזית, 16.5.11' path='/' idx={13} />
      </Grid>
      <Grid item className={styles.item} xs={12} lg={3} md={6}>
