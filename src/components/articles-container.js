...
const ArticlesContainer = () => {
  ...
  return <div dir="rtl" itemScope itemType='https://schema.org/CollectionPage'>
    <Grid container className={styles.container} spacing={1} >
      ...
      <Grid item  xs={12} lg={3} md={6}>
      <ArticleCard header='אפקט כחלון: "מחירי הקרקעות הפרטיות זינקו ב-15%-20%"' preview='"הזוגות הצעירים הם רק 30% משוק הדיור - מה עם השאר?"' src='וואלה! NEWS ב- 22/05/2016' path='https://nadlan.walla.co.il/item/2963345' idx={5} />
      </Grid>
      <Grid item  xs={12} lg={3} md={6}>
      ...
      <Grid item  xs={12} lg={3} md={6}>
      <ArticleCard header='"מצא את ההבדלים"' preview='הן צמודות זו לזו, חולקות את אותו הנוף ובעלות אותו מרחק ממרכז הארץ. ובכל זאת, יש ביניהן הבדלים רבים ברמות הביקוש ובמחירי הדירות.' src='כלכליסט 28/4/2011' path='/' idx={12} />
      </Grid>
    </Grid>
</div>
};
