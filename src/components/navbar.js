      ...
      {scroll ? (
        <div className={`${styles.navbar} navbar-black`}>
          <div
            ...
            className={deviceLarge ? styles.logos_large : styles.logos}
          >
            <div>
              <a
              ...
              <a
                ...
                alt="facebook"
              >
                <Icon icon={facebookIcon} className={styles.social_facebook} />
              </a>
            </div>
            <Link to="/">
              <img
        ...
        <div className={styles.navbar}>
          <div className={styles.logos}>
            <div>
              ...
              >
                <Icon
                  icon={instagramIcon}
                  className={styles.social_instagram_white}
                />
              </a>
              <a
                href="https://www.facebook.com/Zeitouni.Group.ltd.IL/"
              ...
              >
                <Icon
                  icon={facebookIcon}
                  className={styles.social_facebook_white}
                />
              </a>
            </div>
          </div>
          <div
            className={
              deviceLarge ? styles.menu_white_large : styles.menu_white
            }
          ></div>
        </div>
      )}
